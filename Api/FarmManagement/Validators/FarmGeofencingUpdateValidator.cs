...
{
    public class FarmGeofencingUpdateValidator : AbstractValidator<FarmGeofencingUpdateRequest>
    {
        public FarmGeofencingUpdateValidator()
        {
            RuleFor(geofencing => geofencing.GeofenceId)
                .GreaterThan(0).WithMessage("Geofence ID must be a positive integer.");
